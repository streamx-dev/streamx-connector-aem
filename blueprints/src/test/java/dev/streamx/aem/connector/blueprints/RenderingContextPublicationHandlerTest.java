...
class RenderingContextPublicationHandlerTest {
  ...
  void mustHandle() {
    ...
    assertThat(model.getRendererKey()).isEqualTo("/content/experience-fragments/templates/sample-rendering-context.html");
    ...
    assertThat(publishData.getKey()).isEqualTo("/content/experience-fragments/templates/sample-rendering-context.html");
    assertThat(unpublishData.getKey()).isEqualTo("/content/experience-fragments/templates/sample-rendering-context");
  }
}
